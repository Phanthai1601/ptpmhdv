                    ...
                    <table className="w-full text-gray-700 border border-gray-200 rounded-sm">
                        <thead>
                            <tr className="bg-gray-100">
                                ...
                                <th className="py-2 text-left">ID sản phẩm</th>
                        ...
                        <tbody>
                            {recentOrders.map((order) => (
                                <tr key={order.id} className="border-b">
                                    <td>
                                        <Link to={`/admin/recentorders/${order.id}`}>#{order.id}</Link>
                                    </td>
                                    <td>
                                        <Link to={`/admin/products/${order.product_id}`}>{order.product_id}</Link>
                                    </td>
                                    <td>
